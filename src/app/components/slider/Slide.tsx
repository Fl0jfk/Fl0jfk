...
function Slide({author, job, photoAuthor, testimonial, website, linkedin}:SliderProps){
    ...
    return (
            <div className='flex h-[400px] sm:h-[450px] md:h-[350px] min-w-[75%] rounded-xl sm:flex-col md:flex-col items-center justify-center m-4 p-4 sm:p-[1px] md:p-[1px] gap-4 border-[1px] border-[#6A6A6A] cursor-grab active:cursor-grabbing'>
              {author && 
                <>           
                        ...
                        <div className='flex gap-4 sm:gap-0 md:gap-0 items-center sm:flex-col md:flex-col sm:mt-[5px] md:mt-[5px]'>
                            ...
                            {website&& <Link href={website} aria-label={`Link to website of ${author}`} target="blank">
                                <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='mt-[3px]'>
                                  <g strokeWidth="1"></g>
                                  <g strokeLinecap="round" strokeLinejoin="round" fill="#fff"></g>
                                  <g> 
                                    <path d="M14 7H16C18.7614 7 21 9.23858 21 12C21 14.7614 18.7614 17 16 17H14M10 7H8C5.23858 7 3 9.23858 3 12C3 14.7614 5.23858 17 8 17H10M8 12H16" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                  </g>
                                </svg>
                              </Link>}
                        </div>
