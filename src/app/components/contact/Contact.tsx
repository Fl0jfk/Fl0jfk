...
function Contact (){
    return (
        <section id="contact" className="p-4 flex flex-col gap-10">
            ...
            <div className="flex w-full items-center justify-center gap-4">
                ...
                <Link href={"sms:06.09.56.28.13?body=Salut Florian, ton profil m'intéresse!"}>
                    <svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Link href={"https://www.linkedin.com/in/florian-hacqueville-mathi-a9a557254"}>
