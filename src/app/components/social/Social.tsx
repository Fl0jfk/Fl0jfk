...
function Social ({direction}: SocialProps) {
    const directionOFIcons = (direction === 'column' ? "flex-col self-end mb-4 items-end justify-end": "flex-row ");
    const styleOfBar = (direction === 'column' ? "" : "")
    return (
        <>  
            <div className='flex flex-col gap-3 justify-end items-center'>
                ...
                <div className={`flex ${directionOFIcons} gap-3`}>
                    ...
                    <Link href='https://github.com/Fl0jfk'>
                        <svg width="20px" height="20px" viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
