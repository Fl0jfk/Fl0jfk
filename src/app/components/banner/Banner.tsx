    ...
    return (
        <section className="px-24 pt-4 xl:pt-16 flex justify-center items-end md:px-12 sm:px-8">
          <div className="flex max-w-6xl wrap items-stretch">
            <div className="flex flex-col gap-4 justify-center items-start mb-4">
            ...
            <div className="flex items-end">
              { data.profile.profilePhoto &&<Image id="bannerImage" src={data.profile.profilePhoto} alt="My profile photo" width={500} height={500} className="rounded-full opacity-80"/>}
            </div>
          </div>
        </section>
    );
